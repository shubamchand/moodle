...
$themeblocks = new theme_ausinet\custom_blocks;

// echo $PAGE->pagetype;
if ($PAGE->pagetype == 'my-index') {
    $themeblocks->add_block('counter', 'content');
}
...
echo $OUTPUT->render_from_template('theme_ausinet/columns2', $templatecontext);
