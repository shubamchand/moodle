 ...
 * observation with conditional branching.
 */
...
M.mod_observation = M.mod_observation || {};

/* exported Y */
/* exported e */
M.mod_observation.init_attempt_form = function(Y) {
    M.core_formchangechecker.init({formid: 'phpesp_response'});
};

M.mod_observation.init_sendmessage = function(Y) {
