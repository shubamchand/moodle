@mod @mod_observation
Feature: Observation responses can be saved and resumed without submitting.
  When save is used on a response, a response can be resumed with the saved responses intact.

  Background: Add a observation with "Save/Resume answers" set to "Yes".
    ...
    And the following "activities" exist:
      ...
      | observation | Observation 1 | Observation description | C1 | observation0 | 1 |

    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Observation 1"
  ...
  Scenario: Student completes first question and saves response. Resumes with saved response already present.
    ...
    Then I should see "Observation 1"
    ...
    And I am on "Course 1" course homepage
    And I follow "Observation 1"
    Then I should see "Resume observation"
    And I navigate to "Resume observation" in current page administration
    Then I should see "Observation 1"
    And I should see "Select one or two choices only"
    ...
    And I am on "Course 1" course homepage
    And I follow "Observation 1"
    Then I should not see "Resume observation"
