...
Feature: Radio questions allow optional "other" responses with optional labels
  ...
  Background: Add two radio button question to a observation with both "other" choice options specified
...
@javascript
  Scenario: Student selects other options and enters their own text.
    ...
    Then I should see "Test observation"
    ...
    And I should see "Test observation"
