@mod @mod_observation
Feature: In observation, dropdown questions can be defined with scores attributed to specific answers, in order
  ...
  @javascript
  Scenario: Create a observation with a dropdown question type and verify that feedback options exist.
