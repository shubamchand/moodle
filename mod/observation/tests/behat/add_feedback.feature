@mod @mod_observation
Feature: In observation, personality tests can be constructed using feedback on specific question responses.
  In order to define a feedback observation
  As a teacher
  I must add the required question types and complete the feedback options.

  @javascript
  Scenario: Create a observation with a rate question type and verify that feedback options exist.
    ...
    And the following "activities" exist:
      ...
      | observation | Test observation | Test observation description | C1 | observation0 | 1 | 1 |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test observation"
    And I navigate to "Feedback" in current page administration
    Then I should see "Feedback options are available if your observation contains the following question types"
