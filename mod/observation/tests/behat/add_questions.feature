@mod @mod_observation
Feature: Add questions to a observation activity
  In order to conduct surveys of the users in a course
  As a teacher
  I need to add a observation activity with questions to a moodle course

@javascript
  Scenario: Add a observation to a course with one of each question type
