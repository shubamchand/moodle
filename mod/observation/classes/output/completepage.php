...
/**
 * Contains class mod_observation\output\viewpage
 *
...
class completepage implements \renderable, \templatable {
    ...
    public function cansubmit() {
        ...
        return ($userrole == 'student') ? false : true;
    }
