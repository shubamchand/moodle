...
/**
 * This file contains the parent class for observation response types.
 *
...
abstract class responsetype {
    ...
    // Class properties.
    /** @var \mod_observation\question\question $question The question for this response. */
    public $question;

    /** @var int $responseid The id of the response this is for. */
    public $responseid;

    /** @var array $choices An array of \mod_observation\responsetype\choice objects. */
    public $choices;
     ...
     * @param array $choices
     */
    public function __construct(\mod_observation\question\question $question, int $responseid = null, array $choices = []) {
    ...
    static public function all_response_tables() {
        return ['observation_response_bool', 'observation_response_date', 'observation_response_other',
            'observation_response_rank', 'observation_response_text', 'observation_resp_multiple',
            'observation_resp_single'];
    }
     ...
     *
     * @param $weights
     * @param $participants Number of observation participants.
    ...
    public function get_results_tags($weights, $participants, $respondents, $showtotals = 1, $sort = '') {
        ...
        $precision = 0;
        $alt = '';
        $imageurl = $CFG->wwwroot.'/mod/observation/images/';
    ...
    /**
     * Return all the fields to be used for users in bulk observation sql.
     *
     * @author: Guy Thomas
     * @return string
     */
    ...
    protected function bulk_sql_config() {
        return new bulk_sql_config('observation_response_other', 'qro', true, true, false);
    }
