...
class date extends responsetype {
    ...
    static public function response_table() {
        return 'observation_response_date';
    }
    ...
    /**
     * @param \mod_observation\responsetype\response\response\ $responsedata
     * @return bool|int
    ...
    public function results_template() {
        return 'mod_observation/results_date';
    }
    ...
    static public function response_select($rid) {
        ...
        foreach ($records as $qid => $row) {
            ...
            foreach ($row as $key => $val) {
                if (!is_numeric($key)) {
                    $newrow[] = $val;
                    // Convert date from yyyy-mm-dd database format to actual observation dateformat.
