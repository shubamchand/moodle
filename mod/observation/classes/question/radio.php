...
use mod_observation\question\choice\choice;
...
class radio extends question {
    ...
    protected function responseclass() {
        return '\\mod_observation\\responsetype\\single';
    }
    ...
    public function question_template() {
        return 'mod_observation/question_radio';
    }
    ...
    public function response_template() {
        return 'mod_observation/response_radio';
    }
    ...
    protected function question_survey_display($response, $dependants=[], $blankobservation=false) {
        ...
        if (!$this->required()) {
            ...
            if (!$ischecked && !$blankobservation) {
                $radio->checked = true;
            }
            $content = get_string('noanswer', 'observation');
    ...
    protected function form_length(\MoodleQuickForm $mform, $helptext = '') {
        $lengroup = [];
        $lengroup[] =& $mform->createElement('radio', 'length', '', get_string('vertical', 'observation'), '0');
        $lengroup[] =& $mform->createElement('radio', 'length', '', get_string('horizontal', 'observation'), '1');
        $mform->addGroup($lengroup, 'lengroup', get_string('alignment', 'observation'), ' ', false);
        $mform->addHelpButton('lengroup', 'alignment', 'observation');
