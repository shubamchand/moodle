...
class date extends question {
    ...
    protected function responseclass() {
        return '\\mod_observation\\responsetype\\date';
    }
    ...
    public function question_template() {
        return 'mod_observation/question_date';
    }
    ...
    public function response_template() {
        return 'mod_observation/response_date';
    }
    ...
    protected function question_survey_display($response, $descendantsdata, $blankobservation=false) {
        ...
        if (!empty($response->answers[$this->id])) {
            ...
            if ($setdate == 'wrongdateformat') {
                $msg = get_string('wrongdateformat', 'observation', $dateentered);
                $this->add_notification($msg);
            } else if ($setdate == 'wrongdaterange') {
                $msg = get_string('wrongdaterange', 'observation');
                $this->add_notification($msg);
            } else {
