...
$string['activityoverview'] = 'You have observations that are due';
$string['additionalinfo'] = 'Additional Info';
$string['additionalinfo_help'] = 'Text to be displayed at the top of the first page of this observation. (i.e. instructions, background info, etc.)';
...
$string['alignment_link'] = 'mod/observation/questions#Radio_Buttons';
$string['all'] = 'All';
...
$string['alreadyfilled'] = 'You have already filled out this observation for us{$a}. Thank you.';
...
$string['attempted'] = 'This observation has been submitted.';
...
$string['autonumbering_help'] = 'Automatic numbering of questions and pages. You might want to disable automatic numbering
 for observations with conditional branching.';
...
$string['cannotviewpublicresponses'] = 'You cannot view responses to this public observation.';
...
$string['checkboxes_link'] = 'mod/observation/questions#Check_Boxes';
...
$string['closed'] = 'The observation was closed on {$a}. Thanks.';
$string['closedate'] = 'Use Close Date';
$string['closeson'] = 'Observation closes on {$a}';
$string['closedate_help'] = 'You can specify a date to close the observation here. Check the check box, and select the date and time you want.
 Users will not be able to fill out the observation after that date. If this is not selected, it will never be closed.';
$string['completionsubmit'] = 'Student must submit this observation to complete it';
...
$string['confirmdelallresp'] = 'Are you sure you want to delete ALL the responses in this observation?';
...
$string['confpage_help'] = 'Heading (in bold) and body text for the "Confirmation" page displayed after a user completes this observation. (URL, if present, takes precedence over confirmation text.) If you leave this field empty, a default message will be displayed upon observation completion (Thank you for completing this Observation).';
$string['confpagedesc'] = 'Heading (in bold) and body text for the &quot;Confirmation&quot; page displayed after a user completes this observation. (URL, if present, takes precedence over confirmation text.)';
...
$string['createcontent_link'] = 'mod/observation/mod#Content_Options';
...
$string['date_link'] = 'mod/observation/questions#Date';
...
$string['deletedallresp'] = 'Observation responses deleted';
...
$string['dependquestion_link'] = 'mod/observation/questions#Parent_Question';
...
$string['downloadtextformat_help'] = 'This feature enables you to save all the responses of a observation to a text file (CSV).
...
$string['downloadtextformat_link'] = 'mod/observation/report#Download_in_text_format';
...
$string['dropdown_link'] = 'mod/observation/questions#Dropdown_Box';
$string['edit'] = 'Edit';
$string['editingfeedback'] = 'Editing feedback settings';
$string['editingobservation'] = 'Editing Observation Settings';
$string['editquestion'] = 'Editing {$a} question';
$string['email'] = 'Email';
$string['errnewname'] = 'Sorry, name already in use. Pick a new name.';
$string['erroropening'] = 'Error opening observation.';
...
$string['event_previewed'] = 'Observation previewed';
...
$string['feedback_link'] = 'mod/observation/personality_test#Editing_Observation_Feedback_Messages';
...
$string['feedbackeditingglobal'] = 'Editing Observation Global Feedback';
$string['feedbackeditingsections'] = 'Editing Observation Feedback Sections';
$string['feedbackeditingmessages'] = 'Editing Observation Feedback Messages';
...
$string['feedbackoptions_help'] = 'Feedback options are available if your observation contains the following question types and question settings:
...
$string['feedbackoptions_link'] = 'mod/observation/personality_test';
...
$string['feedbacksectionsselect_link'] = 'mod/observation/personality_test#Editing_Observation_Feedback_Sections_2';
...
$string['finished'] = 'You have answered all the questions in this observation!';
$string['firstrespondent'] = 'First Respondent';
$string['formateditor'] = 'HTML editor';
$string['formatplain'] = 'Plain text';
$string['grade'] = 'Submission grade';
$string['gradesdeleted'] = 'Observation grades deleted';
...
$string['kindofratescale_link'] = 'mod/observation/questions#Type_of_rate_scale';
$string['lastrespondent'] = 'Last Respondent';
$string['length'] = 'Length';
$string['managequestions'] = 'Manage questions';
$string['managequestions_help'] = 'In the Manage questions section of the Edit Questions page, you can conduct a number of operations on a Observation\'s questions.';
$string['managequestions_link'] = 'mod/observation/questions#Manage_questions';
...
$string['maxdigitsallowed_link'] = 'mod/observation/questions#Numeric';
...
your Observation or in the text of relevant questions.';
...
Default values are 20 characters for the Input Box width and 25 characters for the maximum length of text entered.';
$string['messageprovider:message'] = 'Observation reminder';
$string['messageprovider:notification'] = 'Observation submission';
...
$string['modulename_help'] = 'The observation module allows you to construct surveys using a variety of question types, for the purpose of gathering data from users.';
$string['modulename_link'] = 'mod/observation/view';
...
$string['navigate_help'] = 'Enable Yes/No and Radio Buttons questions to have Child questions dependent on their choices in your observation.';
$string['navigate_link'] = 'mod/observation/conditional_branching';
$string['navigatetosection'] = 'Go to feedback section';
$string['next'] = 'Next';
$string['nextpage'] = 'Next Page';
$string['nlines'] = '{$a} lines';
$string['noanswer'] = 'No answer';
$string['noattempts'] = 'No attempts have been made on this observation';
...
$string['noneinuse'] = 'This observation does not contain any questions.';
$string['non_respondents'] = 'Users who have not yet submitted their responses to this observation';
$string['nopublicsurveys'] = 'No public observations.';
...
$string['notavail'] = 'This observation is no longer available. Ask your teacher to delete it.';
$string['noteligible'] = 'You are not eligible to take this observation.';
$string['notemplatesurveys'] = 'No template observations.';
...
$string['notifications_help'] = 'Notify roles with the "mod/observation:submissionnotification" capability when a submission is made.';
$string['notifications_link'] = 'mod/observation/mod#Submission_Notifications';
$string['notopen'] = 'This observation will not open until {$a}.';
$string['notrequired'] = 'Response is not required';
$string['notset'] = 'not set';
$string['not_started'] = 'not started';
$string['nousersselected'] = 'No users selected';
$string['num'] = '#';
$string['numattemptsmade'] = '{$a} attempts made on this observation';
...
$string['numberofdecimaldigits_help'] = 'Use **Nb of decimal digits** to specify the format of the Average value counted and displayed at the Observation Report page.';
$string['numberofdecimaldigits_link'] = 'mod/observation/questions#Numeric';
...
$string['opendate_help'] = 'You can specify a date to open the observation here. Check the check box, and select the date and time you want.
 Users will not be able to fill out the observation before that date. If this is not selected, it will be open immediately.';
...
$string['optionalname_help'] = 'The Question Name is only used when you export responses to CSV/Excel format.
 ...
 If you plan to regularly export your observation data to CSV, then you have a choice of two options for question naming. ';
$string['optionalname_link'] = 'mod/observation/questions#Question_Name';
$string['or'] = '- OR -';
...
When you arrive on the All Responses page, by default all responses are ordered in the order that the observation creator entered the question choices.
 You can choose to order them by ascending or descending order.';
$string['orderresponses_link'] = 'mod/observation/report#Order_Responses';
...
$string['preview_observation'] = 'Observation Preview';
$string['previewing'] = ' Previewing Observation ';
$string['previous'] = 'Previous';
$string['previouspage'] = 'Previous Page';
$string['print'] = 'Print this Response';
$string['printblank'] = 'Print Blank';
$string['printblanktooltip'] = 'Opens printer-friendly window with blank Observation';
$string['printtooltip'] = 'Opens printer-friendly window with current Response';

$string['privacy:metadata:observation_response'] = 'A response in progress or submitted';
$string['privacy:metadata:observation_response:userid'] = 'The ID of the user for this response.';
$string['privacy:metadata:observation_response:observationid'] = 'The ID of the observation record for this response.';
$string['privacy:metadata:observation_response:complete'] = 'The response completion status.';
$string['privacy:metadata:observation_response:grade'] = 'The grade for this response.';
$string['privacy:metadata:observation_response:submitted'] = 'The timestamp for the most recent save for this response.';

$string['privacy:metadata:observation_response_bool'] = 'A boolean (yes/no) question response.';
$string['privacy:metadata:observation_response_bool:response_id'] = 'The ID of the response record for this response.';
$string['privacy:metadata:observation_response_bool:question_id'] = 'The ID of the question record for this response.';
$string['privacy:metadata:observation_response_bool:choice_id'] = 'The specific boolean answer.';

$string['privacy:metadata:observation_response_date'] = 'A date question response.';
$string['privacy:metadata:observation_response_date:response_id'] = 'The ID of the response record for this response.';
$string['privacy:metadata:observation_response_date:question_id'] = 'The ID of the question record for this response.';
$string['privacy:metadata:observation_response_date:response'] = 'The specific date answer.';

$string['privacy:metadata:observation_response_other'] = 'An \'other\' choice text response.';
$string['privacy:metadata:observation_response_other:response_id'] = 'The ID of the response record for this response.';
$string['privacy:metadata:observation_response_other:question_id'] = 'The ID of the question record for this response.';
$string['privacy:metadata:observation_response_other:choice_id'] = 'The ID of the choice record for this response.';
$string['privacy:metadata:observation_response_other:response'] = 'The specific text answer.';

$string['privacy:metadata:observation_response_rank'] = 'A rank question response.';
$string['privacy:metadata:observation_response_rank:response_id'] = 'The ID of the response record for this response.';
$string['privacy:metadata:observation_response_rank:question_id'] = 'The ID of the question record for this response.';
$string['privacy:metadata:observation_response_rank:choice_id'] = 'The ID of the choice record for this response.';
$string['privacy:metadata:observation_response_rank:rankvalue'] = 'The specific rank answer.';

$string['privacy:metadata:observation_response_text'] = 'A text question response.';
$string['privacy:metadata:observation_response_text:response_id'] = 'The ID of the response record for this response.';
$string['privacy:metadata:observation_response_text:question_id'] = 'The ID of the question record for this response.';
$string['privacy:metadata:observation_response_text:response'] = 'The specific text answer.';

$string['privacy:metadata:observation_resp_multiple'] = 'A multiple choice question response.';
$string['privacy:metadata:observation_resp_multiple:response_id'] = 'The ID of the response record for this response.';
$string['privacy:metadata:observation_resp_multiple:question_id'] = 'The ID of the question record for this response.';
$string['privacy:metadata:observation_resp_multiple:choice_id'] = 'The ID of a choice record for this response.';

$string['privacy:metadata:observation_resp_single'] = 'A single choice question response.';
$string['privacy:metadata:observation_resp_single:response_id'] = 'The ID of the response record for this response.';
$string['privacy:metadata:observation_resp_single:question_id'] = 'The ID of the question record for this response.';
$string['privacy:metadata:observation_resp_single:choice_id'] = 'The ID of the choice record for this response.';
...
$string['observation:copysurveys'] = 'Copy template and private observations';
$string['observation:createpublic'] = 'Create public observations';
$string['observation:createtemplates'] = 'Create template observations';
$string['observation:deleteresponses'] = 'Delete any response';
$string['observation:downloadresponses'] = 'Download responses in a CSV file';
$string['observation:editquestions'] = 'Create and edit observation questions';
$string['observation:manage'] = 'Create and edit observations';
$string['observation:message'] = 'Send message to non-respondents';
$string['observation:preview'] = 'Preview observations';
$string['observation:printblank'] = 'Print blank observation';
$string['observation:readallresponseanytime'] = 'Read all responses any time';
$string['observation:readallresponses'] = 'Read response summaries, subject to open times';
$string['observation:readownresponses'] = 'Read own responses';
$string['observation:submissionnotification'] = 'Receive notification for each submission';
$string['observation:submit'] = 'Complete and submit a observation';
$string['observation:view'] = 'View a observation';
$string['observation:viewsingleresponse'] = 'View complete individual responses';
$string['observationadministration'] = 'Observation Administration';
$string['observationcloses'] = 'Observation Closes';
$string['observationopens'] = 'Observation Opens';
$string['observationreport'] = 'Observation Report';
...
$string['questiontypes_link'] = 'mod/observation/questions#Question_Types';
...
$string['radiobuttons_link'] = 'mod/observation/questions#Radio_Buttons';
$string['rank'] = 'Rank';
$string['ratescale'] = 'Rate (scale 1..5)';
$string['ratescale_help'] = 'See the Moodle Documentation below';
$string['ratescale_link'] = 'mod/observation/questions#Rate_.28scale_1..5.29';
$string['realm'] = 'Observation Type';
$string['realm_help'] = '* **There are  three types of observations:**
 * Private - belongs to the course it is defined in only.
 * Template - can be copied and edited.
 * Public - can be shared among courses.';
$string['realm_link'] = 'mod/observation/qsettings#Observation_Type';
$string['redirecturl'] = 'The URL to which a user is redirected after completing this observation.';
$string['remove'] = 'Delete';
$string['removenotinuse'] = 'This observation used to depend on a Public observation which has been deleted.
...
the respondent will not be able to submit the observation
until this question has been answered.';
$string['required_link'] = 'mod/observation/questions#Response_Required';
$string['requiredparameter'] = 'A required parameter was missing.';
$string['reset'] = 'Reset';
$string['removeallobservationattempts'] = 'Delete all observation responses';
...
$string['respondenttype_link'] = 'mod/observation/mod#Respondent_Type';
...
$string['responseview_help'] = 'You can specify who can see the responses of all respondents to submitted observations (general statistics tables).';
$string['responseview_link'] = 'mod/observation/mod#Response_viewing';
$string['responseviewstudentsalways'] = 'Always';
$string['responseviewstudentsnever'] = 'Never';
$string['responseviewstudentswhenanswered'] = 'After answering the observation';
$string['responseviewstudentswhenclosed'] = 'After the observation is closed';
$string['restrictedtoteacher'] = 'These functions are restricted to editing teachers only!';
$string['resume'] = 'Save/Resume answers';
$string['resume_help'] = 'Setting this option allows users to save their answers to a observation before submitting them.
 Users can leave the observation unfinished and resume from the save point at a later date.';
$string['resume_link'] = 'mod/observation/mod#Save/Resume_answers';
$string['resumesurvey'] = 'Resume observation';
$string['return'] = 'Return';
$string['save'] = 'Save';
$string['saveasnew'] = 'Save as New Question';
$string['savedbutnotsubmitted'] = 'This observation has been saved but not yet submitted.';
$string['savedprogress'] = 'Your progress has been saved.  You may return at any time to complete this observation.';
$string['saveeditedquestion'] = 'Save question {$a}';
$string['savesettings'] = 'Save settings';
$string['search:activity'] = 'Observation - activity information';
$string['search:question'] = 'Observation - questions';
...
$string['selecttheme'] = 'Select a theme (css) to use with this observation.';
$string['send'] = 'Send';
...
$string['submitsurvey'] = 'Submit observation';
$string['submitted'] = 'Submitted on:';
$string['subtitle'] = 'Subtitle';
$string['subtitle_help'] = 'Subtitle of this observation. Appears below the title on the first page only.';
$string['subject'] = 'Subject';
$string['summary'] = 'Summary';
$string['surveynotexists'] = 'observation does not exist.';
$string['surveyowner'] = 'You must be a observation owner to perform this operation.';
$string['surveyresponse'] = 'Response from observation';
$string['template'] = 'Template';
$string['templatenotviewable'] = 'Template observations are not viewable.';
...
$string['thank_head'] = 'Thank you for completing this Observation.';
$string['theme'] = 'Theme';
...
$string['title'] = 'Title';
$string['title_help'] = 'Title of this observation, which will appear at the top of every page. By default Title is set to the observation Name, but you can edit it as you like.';
$string['today'] = 'today';
$string['total'] = 'Total';
...
$string['unknownaction'] = 'Unknown observation action specified...';
$string['url'] = 'Confirmation URL';
$string['url_help'] = 'The URL to which a user is redirected after completing this observation.';
...
$string['viewallresponses_help'] = 'If the observation is set to **Group Mode**: *Visible groups*, or is set to *Separate groups* and the current user
 has the *moodle/site:accessallgroups* capability (in the current context), and groups have been defined in the current course,
 then the user has access to a dropdown list of groups. This dropdown list enables the user to "filter" the observation responses by groups.
...
$string['viewallresponses_link'] = 'Viewing_Observation_responses#Group_filtering';
...
$string['crontask'] = 'Observation cleanup job';
$string['selectstudent'] = 'Select Student';

$string['observation_student'] = 'Observation For Student';