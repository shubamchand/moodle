...
require_once($CFG->dirroot . '/mod/observation/backup/moodle2/backup_observation_settingslib.php');

/**
 * observation backup task that provides all the settings and steps to perform one
