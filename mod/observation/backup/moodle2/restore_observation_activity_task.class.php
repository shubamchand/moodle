...
class restore_observation_activity_task extends restore_activity_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('observation_survey',
                        array('info', 'thank_head', 'thank_body', 'thanks_page'), 'observation_survey');
        $contents[] = new restore_decode_content('observation_question', array('content'), 'observation_question');
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('observation', 'choose', 'view.php?id={course_module}', '{observation}');
        $rules[] = new restore_log_rule('observation', 'choose again', 'view.php?id={course_module}', '{observation}');
        $rules[] = new restore_log_rule('observation', 'report', 'report.php?id={course_module}', '{observation}');
    ...
    static public function define_restore_log_rules_for_course() {
        ...
        $rules[] = new restore_log_rule('observation', 'view all', 'index?id={course}', null,
