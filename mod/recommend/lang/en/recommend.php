...
$string['current_date'] = "Current date"; // added by nirmal recommend
$string['phone_number'] = "Phone number"; // added by nirmal recommend
$string['recommendatorphone'] = 'Phone number'; // added by nirmal recommend
