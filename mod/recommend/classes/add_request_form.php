...
class mod_recommend_add_request_form extends moodleform {
    ...
    public function definition() {
        ...
        for ($i = 1; $i <= $canadd; $i++) {
            ...
            $mform->addElement('text', 'phone_number'.$i, get_string('recommendatorphone', 'recommend')); // added by nirmal recommend
            $mform->setType('phone_number'.$i, PARAM_TEXT); // added by nirmal recommend
